...
var Filler = function (_a) {
    ...
    if (offset !== undefined) {
        outerStyle = __assign({ height: height, position: 'relative', overflow: 'hidden', overflowAnchor: 'none', zIndex: 0 }, propsOuterStyle);
        ...
        outerStyle = __assign({ overflowAnchor: 'none' }, propsOuterStyle);
