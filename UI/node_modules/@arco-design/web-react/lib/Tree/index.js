...
var Tree = /** @class */ (function (_super) {
    ...
    Tree.prototype.componentDidUpdate = function (prevProps) {
        ...
        if (prevProps !== this.props || !(0, isEqualWith_1.default)(prevMergedProps, mergedProps)) {
            var newState = {};
            var shouldUsePropsNodeList = !('treeData' in this.props);
            var latestTreeData_1 = this.state.treeData;
            var treeDataChanged = this.needUpdateTreeData(__assign(__assign({}, prevMergedProps), prevProps), __assign(__assign({}, mergedProps), this.props));
            if (treeDataChanged) {
                var treeData = this.getTreeData();
                latestTreeData_1 = treeData;
                ...
                if ('expandedKeys' in this.props) {
                    var derivedExpandedKeys = this.getInitExpandedKeys(this.props.expandedKeys || []);
                    newState.expandedKeys = derivedExpandedKeys;
                    newState.currentExpandKeys = !mergedProps.animation
                        ? []
                        : __spreadArray(__spreadArray([], __read(derivedExpandedKeys), false), __read(this.state.expandedKeys), false).reduce(function (total, next) {
            ...
            if ('expandedKeys' in this.props &&
                ...
                newState.currentExpandKeys = !mergedProps.animation
                    ? []
                    : __spreadArray(__spreadArray([], __read(newState.expandedKeys), false), __read(this.state.expandedKeys), false).reduce(function (total, next) {
                        var index = total.indexOf(next);
                        if (index === -1) {
                            total.push(next);
                        }
            ...
            var currentExpandKeys = newState.currentExpandKeys || this.state.currentExpandKeys;
            if (treeDataChanged && currentExpandKeys) {
                newState.currentExpandKeys = currentExpandKeys.filter(function (key) {
                    var item = latestTreeData_1 === null || latestTreeData_1 === void 0 ? void 0 : latestTreeData_1.find(function (node) { return node.key === key; });
    ...
    Tree.prototype.render = function () {
        ...
        var nodeList = 'treeData' in this.props ? this.state.nodeList : this.getNodeList(this.getTreeData());
