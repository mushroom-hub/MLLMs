...
var Picker = function (baseProps, ref) {
    ...
    var prevPopupVisibleRef = useRef(mergedPopupVisible);
    ...
    var nowValue = getNow(utcOffset, timezone);
    var nowDisabled = isDisabledDate(nowValue, disabledDate, 'date');
    function focusInput() {
        var _a, _b;
    ...
    function onConfirmTimeValue(v) {
        ...
        var newValue = getValueWithTime(_valueShow, v);
        setValue(newValue);
    ...
    function onSelectNow() {
        ...
        var now = getLocaleDayjsValue(nowValue, locale.dayjsLocale);
    ...
    function renderPopup(panelOnly) {
        ...
        var disableConfirm = Boolean((props.timepickerProps && props.timepickerProps.disableConfirm) ||
            (isObject(showTime) && showTime.disableConfirm));
