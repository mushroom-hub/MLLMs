...
var OverflowWrap = function (props) {
    ...
    var lastMeasuredWidthRef = useRef(0);
    ...
    var computeLastVisibleIndex = useCallback(function () {
        if (!refUl.current) {
            return;
        }
    ...
    return (React.createElement(ResizeObserver, { onResize: computeLastVisibleIndex, delayOnResizeByRaf: true, getTargetDOMNode: function () { return refUl.current; } },
