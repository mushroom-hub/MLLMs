...
var CoreSelectView = React.forwardRef(function (props, ref) {
    ...
    var _g = __read(useState(), 2), compositionText = _g[0], setCompositionText = _g[1];
    ...
    var renderSingle = function () {
        ...
        return (React.createElement("span", { className: prefixCls + "-view-selector" },
            ...
            needShowInput ? (React.createElement("span", { className: prefixCls + "-view-value-mirror" }, fillNBSP(compositionText !== undefined
                ? compositionText
                : inputProps.value
                    ? inputTextValue
