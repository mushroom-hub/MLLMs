...
_c) {
    ...
    var handleOption = function (child, origin) {
        ...
        var optionLabel = (0, get_1.default)(child, 'props.children');
        var searchValue = inputValue.toLowerCase();
        var hasExplicitValue = (0, get_1.default)(child, 'props.value') !== undefined;
        var isValidOption = true;
        if (filterOption === true) {
            var isValueMatched = optionValue !== undefined && String(optionValue).toLowerCase().indexOf(searchValue) !== -1;
            var isLabelMatched = typeof optionLabel === 'string' && optionLabel.toLowerCase().indexOf(searchValue) !== -1;
