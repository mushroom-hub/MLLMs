...
var nodeToText = function (node) {
    ...
    if (Array.isArray(node)) {
        return node.map(function (item) { return nodeToText(item); }).join('');
    }
    if (react_1.default.isValidElement(node)) {
        return nodeToText((_a = node.props) === null || _a === void 0 ? void 0 : _a.children);
    }
    return '';
};
var SearchStatus = {
...
var CoreSelectView = react_1.default.forwardRef(function (props, ref) {
    ...
    var _g = __read((0, react_1.useState)(), 2), compositionText = _g[0], setCompositionText = _g[1];
    ...
    var renderedTextResult = !isMultiple && value !== undefined ? renderText(value) : null;
    var renderedValue = (_c = renderedTextResult === null || renderedTextResult === void 0 ? void 0 : renderedTextResult.text) !== null && _c !== void 0 ? _c : '';
    var renderedValueInput = renderedTextResult === null || renderedTextResult === void 0 ? void 0 : renderedTextResult.textInput;
    var renderedValuePlain = renderedValueInput !== undefined
        ? renderedValueInput
    ...
    var renderSingle = function () {
        ...
        var inputTextValue = typeof _inputValue === 'string' || typeof _inputValue === 'number'
            ? String(_inputValue)
            : '';
        var inputProps = {
            style: { width: '100%' },
            ...
            placeholder: canFocusInput && (!!renderedValuePlain || renderedValue === 0)
                ? renderedValuePlain
                : placeholder,
        };
        if (canFocusInput) {
        ...
        return (react_1.default.createElement("span", { className: prefixCls + "-view-selector" },
            ...
            needShowInput ? (react_1.default.createElement("span", { className: prefixCls + "-view-value-mirror" }, (0, fillNBSP_1.default)(compositionText !== undefined
                ? compositionText
                : inputProps.value
                    ? inputTextValue
