...
function TreeNode(props, ref) {
    ...
    var getPrefixIcon = function () {
        ...
        if (icon) {
            icon = (React.createElement("span", { className: prefixCls + "-switcher-icon", "aria-label": expanded ? 'fold button' : 'expand button', role: "button", tabIndex: 0, onMouseDown: function (e) { return e.preventDefault(); }, onClick: switchExpandStatus }, icon));
