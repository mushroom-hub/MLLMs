...
var ResizeObserverComponent = /** @class */ (function (_super) {
    ...
    function ResizeObserverComponent() {
        ...
        _this.componentWillUnmount = function () {
            if (_this.resizeFrameId) {
                cancelAnimationFrame(_this.resizeFrameId);
                _this.resizeFrameId = null;
            }
        ...
        _this.createResizeObserver = function () {
            var _a = _this.props, _b = _a.throttle, throttle = _b === void 0 ? true : _b, _c = _a.delayOnResizeByRaf, delayOnResizeByRaf = _c === void 0 ? false : _c;
            ...
            _this.resizeObserver = new resize_observer_polyfill_1.default(function (entry) {
                ...
                if (delayOnResizeByRaf) {
                    _this.latestEntry = entry;
                    if (!_this.resizeFrameId) {
                        _this.resizeFrameId = requestAnimationFrame(function () {
                            _this.resizeFrameId = null;
                            resizeHandler(_this.latestEntry);
                        });
                    }
                    return;
                }
