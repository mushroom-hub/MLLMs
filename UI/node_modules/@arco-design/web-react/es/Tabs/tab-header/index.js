...
var TabHeader = React.forwardRef(function (props, ref) {
    ...
    var _e = __read(useDomSize(), 3), scrollWrapperRef = _e[0], setScrollWrapperSize = _e[2];
    var _f = __read(useDomSize(), 3), extraRef = _f[0], setExtraSize = _f[2];
    var _g = __read(useDomSize(), 3), addBtnRef = _g[0], setAddenBtnSize = _g[2];
    var titleRef = useRef({});
    ...
    var _k = __read(useState(false), 2), isScrolling = _k[0], setIsScrolling = _k[1];
