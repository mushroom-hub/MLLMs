...
function Table(baseProps, ref) {
    ...
    var syncingScrollTargets = (0, react_1.useRef)([]);
    ...
    function getDefaultFiltersAndSorters() {
        ...
        flattenColumns.forEach(function (column) {
            ...
            var hasDefaultSortOrder = 'defaultSortOrder' in column &&
                typeof column.defaultSortOrder !== 'undefined' &&
                column.defaultSortOrder !== null;
            var hasSortOrder = 'sortOrder' in column &&
    ...
    function tableScrollHandler(e) {
        ...
        if (syncingScrollTargets.current.includes(scrollTarget)) {
            syncingScrollTargets.current = syncingScrollTargets.current.filter(function (item) { return item !== scrollTarget; });
            lastScrollLeft.current = scrollTarget.scrollLeft;
            return;
        }
        if (scrollTarget.scrollLeft !== lastScrollLeft.current) {
            var syncTargets = [theadScrollContainer, tbody, tfoot].filter(function (node) { return !!node && node !== scrollTarget; });
            syncingScrollTargets.current = syncTargets;
            syncTargets.forEach(function (node) {
    ...
    var tbodyNode = (react_1.default.createElement(index_2.default, __assign({}, props, { saveRef: function (node) {
    ...
    function renderTable() {
        ...
        var summaryFixedBottom = summaryNode && ((fixedHeader && fixedFooterPosition === 'bottom') || virtualized);
