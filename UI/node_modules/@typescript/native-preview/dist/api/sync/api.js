...
class TypeObject {
    ...
    getAliasSymbol() {
        ...
        if (cached)
            return cached;
        const data = this.client.apiRequest("getAliasSymbolOfType", { snapshot: this.snapshotId, type: this.id });
        return data ? this.objectRegistry.getOrCreateSymbol(data) : undefined;
    }
    ...
    getFreshType() {
        ...
        if (cached)
            return cached;
        const data = this.client.apiRequest("getFreshTypeOfType", { snapshot: this.snapshotId, type: this.id });
        return data ? this.objectRegistry.getOrCreateType(data) : undefined;
    }
    getRegularType() {
        if (!this.regularType)
        ...
        if (cached)
            return cached;
        const data = this.client.apiRequest("getRegularTypeOfType", { snapshot: this.snapshotId, type: this.id });
        return data ? this.objectRegistry.getOrCreateType(data) : undefined;
    }
    getTypes() {
