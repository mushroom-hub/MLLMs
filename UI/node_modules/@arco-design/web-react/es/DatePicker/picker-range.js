...
import { getAvailableDayjsLength, getDefaultWeekStart, getLocaleDayjsValue, getFormatByIndex, isDisabledDate as checkDisabledDate, } from './util';
...
var Picker = function (baseProps, ref) {
    ...
    function onHandleSelectShortcut(shortcut) {
        ...
        if (isValidShortcut(shortcut)) {
            ...
            if (time.some(function (item) { return checkDisabledDate(item, disabledDate, mode); })) {
                return;
            }
            onConfirmValue(time);
        }
