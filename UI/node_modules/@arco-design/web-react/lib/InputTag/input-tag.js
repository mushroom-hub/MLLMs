...
function InputTag(baseProps, ref) {
    ...
    var suffixInput = [
        react_1.default.createElement(CSSTransition_1.default, { key: REACT_KEY_FOR_INPUT, timeout: CSS_TRANSITION_DURATION, classNames: "zoomIn" },
            react_1.default.createElement(input_element_1.default, __assign({ autoComplete: "off", size: size, disabled: disableInputComponent, readOnly: readOnly, ref: refInput, autoFocus: autoFocus, placeholder: !value.length ? placeholder : '', prefixCls: prefixCls + "-input" }, (!value.length
                ? {
                    style: {
                        order: -1,
                    },
