...
class RAGEngine:
    ...
    SUBJECT_KEYWORDS = {
        ...
        "计算机组成原理": [
            "冯诺依曼体系", "机器字长", "单周期CPU", "多周期CPU",
            "CPU", "寄存器", "Cache", "缓存", "流水线", "指令集", "ALU",
            "存储器", "总线", "中断", "寻址方式", "MIPS", "汇编", "主频",
        ...
        "计算机网络": [
            ...
            "NAT", "端口", "Socket", "MAC", "以太网", "协议", "network", 
            "Internet", "IP地址", "路由器", "防火墙", "VPN", "代理",
        ],
        "操作系统": [
