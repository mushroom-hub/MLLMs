...
var TabHeader = react_1.default.forwardRef(function (props, ref) {
    ...
    var _e = __read((0, useDomSize_1.default)(), 3), scrollWrapperRef = _e[0], setScrollWrapperSize = _e[2];
    var _f = __read((0, useDomSize_1.default)(), 3), extraRef = _f[0], setExtraSize = _f[2];
    var _g = __read((0, useDomSize_1.default)(), 3), addBtnRef = _g[0], setAddenBtnSize = _g[2];
    ...
    var _k = __read((0, react_1.useState)(false), 2), isScrolling = _k[0], setIsScrolling = _k[1];
    var paneChildren = mergeProps.paneChildren, editable = mergeProps.editable, prefixCls = mergeProps.prefixCls, onAddTab = mergeProps.onAddTab, direction = mergeProps.direction, _l = mergeProps.type, type = _l === void 0 ? 'line' : _l, _m = mergeProps.overflow, overflow = _m === void 0 ? 'scroll' : _m, activeTab = mergeProps.activeTab, showAddButton = mergeProps.showAddButton, _o = mergeProps.size, size = _o === void 0 ? 'default' : _o, style = mergeProps.style, tabPosition = mergeProps.tabPosition, className = mergeProps.className, extra = mergeProps.extra, animation = mergeProps.animation, icons = mergeProps.icons, deleteButton = mergeProps.deleteButton, addButton = mergeProps.addButton, renderTabTitle = mergeProps.renderTabTitle, scrollAfterEdit = mergeProps.scrollAfterEdit, _p = mergeProps.scrollPosition, scrollPosition = _p === void 0 ? 'auto' : _p, inkBarSize = mergeProps.inkBarSize;
    var scrollConfig = (0, is_1.isObject)(scrollAfterEdit)
        ? __assign(__assign({}, SCROLL_MAP), scrollAfterEdit) : SCROLL_MAP;
    var _q = __read(rtl
        ? [ALIGN_RIGHT, ALIGN_LEFT]
        : [ALIGN_LEFT, ALIGN_RIGHT], 2), left = _q[0], right = _q[1];
    var align = type === 'capsule' ? right : left;
    var isScrollable = (0, react_1.useMemo)(function () {
        var wrapperGap = mergeProps.direction === 'vertical'
                ...
                react_1.default.createElement("div", { className: prefixCls + "-header-wrapper", ref: headerWrapperRef },
                    react_1.default.createElement(resizeObserver_1.default, { onResize: onHeaderResize },
                        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-header", (_b = {},
                                ...
                                _b[prefixCls + "-header-scrolling"] = isScrolling,
