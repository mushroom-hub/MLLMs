...
function SplitGroup(props, ref) {
    ...
    function formatSize(size) {
        var _a, _b;
        var totalPX = isHorizontal
            ? (_a = wrapperRef.current) === null || _a === void 0 ? void 0 : _a.offsetWidth
            : (_b = wrapperRef.current) === null || _b === void 0 ? void 0 : _b.offsetHeight;
        if (!size || ((0, is_1.isNumber)(size) && size < 0)) {
            return 0;
        }
        if ((0, is_1.isString)(size)) {
