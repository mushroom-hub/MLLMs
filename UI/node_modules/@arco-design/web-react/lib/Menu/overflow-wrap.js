...
var OverflowWrap = function (props) {
    ...
    var lastMeasuredWidthRef = (0, react_1.useRef)(0);
    ...
    var computeLastVisibleIndex = (0, react_1.useCallback)(function () {
        if (!refUl.current) {
            return;
        }
        var ulElement = refUl.current;
        var currentWidth = getNodeWidth(ulElement);
        if (lastMeasuredWidthRef.current &&
            Math.abs(currentWidth - lastMeasuredWidthRef.current) < WIDTH_CHANGE_THRESHOLD) {
            return;
        }
        lastMeasuredWidthRef.current = currentWidth;
        var maxWidth = currentWidth - OVERFLOW_THRESHOLD;
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: computeLastVisibleIndex, delayOnResizeByRaf: true, getTargetDOMNode: function () { return refUl.current; } },
