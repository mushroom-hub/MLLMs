...
var TextArea = function (baseProps, ref) {
    ...
    var _f = __read(useState({}), 2), textAreaStyle = _f[0], setTextAreaStyle = _f[1];
    var _g = __read(useMergeValue('', {
    ...
    if (withWrapper) {
        ...
        return (React.createElement("div", { className: cs(prefixCls + "-wrapper", (_b = {},
            ...
            withWordLimit && (React.createElement("span", { className: cs(prefixCls + "-word-limit", (_c = {},
