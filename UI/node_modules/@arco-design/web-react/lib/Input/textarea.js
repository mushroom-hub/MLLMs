...
var TextArea = function (baseProps, ref) {
    ...
    var className = props.className, style = props.style, wrapperStyle = props.wrapperStyle, placeholder = props.placeholder, disabled = props.disabled, error = props.error, propMaxLength = props.maxLength, showWordLimit = props.showWordLimit, allowClear = props.allowClear, onChange = props.onChange, onClear = props.onClear, onKeyDown = props.onKeyDown, onPressEnter = props.onPressEnter, status = props.status, clearIcon = props.clearIcon, _e = props.wordLimitPosition, wordLimitPosition = _e === void 0 ? 'inside' : _e, rest = __rest(props, ["className", "style", "wrapperStyle", "placeholder", "disabled", "error", "maxLength", "showWordLimit", "allowClear", "onChange", "onClear", "onKeyDown", "onPressEnter", "status", "clearIcon", "wordLimitPosition"]);
    ...
    var _f = __read((0, react_1.useState)({}), 2), textAreaStyle = _f[0], setTextAreaStyle = _f[1];
    var _g = __read((0, useMergeValue_1.default)('', {
    ...
    var _h = (0, useComposition_1.default)({
        value: value,
        maxLength: maxLength,
        onChange: onChange,
        onKeyDown: onKeyDown,
    ...
    }), compositionValue = _h.compositionValue, compositionHandler = _h.compositionHandler, valueChangeHandler = _h.valueChangeHandler, keyDownHandler = _h.keyDownHandler, triggerValueChangeCallback = _h.triggerValueChangeCallback;
    ...
    var withWordLimit = !!(wordLimitMaxLength && showWordLimit);
    var withWrapper = withWordLimit || allowClear;
    var wordLimitOutside = withWordLimit && wordLimitPosition === 'outside';
    var _j = __read(rtl
        ? [wordLimitMaxLength, valueLength]
        : [valueLength, wordLimitMaxLength], 2), leftWord = _j[0], rightWord = _j[1];
    var wordLimitText = withWordLimit ? leftWord + "/" + rightWord : '';
    ...
    if (withWrapper) {
        ...
        return (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-wrapper", (_b = {},
                ...
                _b[prefixCls + "-wrapper-word-limit-outside"] = wordLimitOutside,
            ...
            withWordLimit && (react_1.default.createElement("span", { className: (0, classNames_1.default)(prefixCls + "-word-limit", (_c = {},
                    _c[prefixCls + "-word-limit-outside"] = wordLimitOutside,
